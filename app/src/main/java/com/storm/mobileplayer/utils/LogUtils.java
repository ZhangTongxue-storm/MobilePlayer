    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MyApplication.mContext.getExternalCacheDir() != null)
                dir = MyApplication.mContext.getExternalCacheDir() + File.separator + "log" + File.separator;
            else {
                dir = MyApplication.mContext.getCacheDir() + File.separator + "log" + File.separator;
            }
        }
